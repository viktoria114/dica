...
import { crearPromocion, getListaPromocionesI, getListaPromocionesV, actualizarPromocion, eliminarPromocion, restaurarPromocion, agregarItemPromocion, eliminarItemPromocion } from '../controllers/promocionesController';
